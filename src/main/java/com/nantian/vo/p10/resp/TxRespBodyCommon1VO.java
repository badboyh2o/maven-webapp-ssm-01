...
public class TxRespBodyCommon1VO {
	...
	private String BSN_MT_ENT_IDR;
	
	public TxRespBodyCommon1VO() {
		super();
	}
	...
	public String getBSN_MT_ENT_IDR() {
		return BSN_MT_ENT_IDR;
	}
	public void setBSN_MT_ENT_IDR(String bSN_MT_ENT_IDR) {
		BSN_MT_ENT_IDR = bSN_MT_ENT_IDR;
	}
